...
namespace spec\RevoTale\ShoppingCart;
...
{
    public function let(CartItemInterface $item, CartItemInterface $item2): void
    {
        // first item
    ...
    public function it_adds_items(): void
    {
    ...
    public function it_sets_items($item, $item2): void
    {
    ...
    public function it_merges_items_of_same_id($item, CartItemInterface $item3): void
    {
        // stub
    ...
    public function it_sorts_items_correctly($item, $item2, CartItemInterface $item3, CartItemInterface $item4): void
    {
        // stub
    ...
    public function it_can_set_rounding(): void
    {
